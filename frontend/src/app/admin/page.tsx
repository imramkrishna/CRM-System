...
const AdminDashboard = () => {
    ...
    const handleReject = async (distributorId: string) => {
        try {
            ...
            if (distributors.length > 1) {
                const nextDistributor = distributors.find(d => d.id !== distributorId);
                setSelectedDistributor(nextDistributor || null);
            } else {
                setSelectedDistributor(null);
            }
    ...
    useEffect(() => {
        if (activeSection === 'verify-distributor') {
            fetchDistributors();
        }
    }, [activeSection]);
                                            ...
                                            <div className="mt-8 pt-6 border-t border-gray-200">
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <div className="flex space-x-3">
                                                        <button
                                                            onClick={() => handleReject(selectedDistributor.id)}
                                                        ...
                                                        <button
                                                            onClick={() => handleApprove(selectedDistributor.id)}
